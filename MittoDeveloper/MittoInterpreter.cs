...
namespace MittoDeveloper
{
  class MittoInterpreter
  {
    ...
    public ArrayList arlBuffer = new ArrayList();
    public List<string> lstVariables = new List<string>();
    public ArrayList arlVariableValues = new ArrayList();
    //public List<string> lstVarDesc = new List<string>();

    //private string strNextDesc = null;
    ...
    public void PrintSource(ArrayList arlSource, int intLevel)
    {
      for (int i = 0; i < arlSource.Count; i++)
      {
        if (arlSource[i].GetType() == typeof(ArrayList))
        {
          OutputF("(\n", 3);
          PrintSource((ArrayList)arlSource[i], intLevel + 1);
        }
        else
    ...
    // Buffer check
    //--------------------------------------------------------------------------------------------------------------------------------
    public void BufferCheck(ref int intMyBufferPos, int intParBufferPos, int intMyPos, ArrayList arlMySource, int intParPos, ArrayList arlParSource, ref int intMySkip, ref int intParSkip, ref int intVariablePop)
    {
      int i, max;
      ...
      for (i = intMyBufferPos; i < max; i++)
      {
          if (IsSymbol(arlBuffer[i]))
          {
            ...
            SymbolEval(strCmd, ref intMyBufferPos, intParBufferPos, intMyPos, arlMySource, intParPos, arlParSource, ref intMySkip, ref intParSkip, ref intVariablePop);
            i--;
            max--;
          }
        //}
    ...
    // Get next symbol
    //--------------------------------------------------------------------------------------------------------------------------------
    public object GetNextSymbol(int intNext, int intPos, ArrayList arlSource)
    {
    ...
    //--------------------------------------------------------------------------------------------------------------------------------
    public ArrayList TakeAny(int intCount, int intMin, int intMyBufferPos, int intMyBufferEnd)
    {
    ...
    //--------------------------------------------------------------------------------------------------------------------------------
    public void LetterEval(object objEval, ref int intMyBufferPos, int intParBufferPos, int intMyPos, ArrayList arlMySource, int intParPos, ArrayList arlParSource, ref int intMySkip, ref int intParSkip, ref int intVariablePop)
    {
      if (objEval == null)
        return;
      else if (objEval.GetType() == typeof(ArrayList))
        MittoEval((ArrayList)objEval, intMyBufferPos, intMyPos, arlMySource, ref intMySkip);
        ...
        SymbolEval((string)objEval, ref intMyBufferPos, intParBufferPos, intMyPos, arlMySource, intParPos, arlParSource, ref intMySkip, ref intParSkip, ref intVariablePop);
    }
    ...
    // Symbol eval
    //--------------------------------------------------------------------------------------------------------------------------------
    public void SymbolEval(string strEval, ref int intMyBufferPos, int intParBufferPos, int intMyPos, ArrayList arlMySource, int intParPos, ArrayList arlParSource, ref int intMySkip, ref int intParSkip, ref int intVariablePop)
    {
      ...
      {
        strCmd = null;
        LetterEval(arlVariableValues[intVarIndex], ref intMyBufferPos, intParBufferPos, intMyPos, arlMySource, intParPos, arlParSource, ref intMySkip, ref intParSkip, ref intVariablePop);
      }
      else
      {
        switch (strCmd)
        {
          //----------------------------------------------------------------
          case ";":
            BufferCheck(ref intMyBufferPos, intParBufferPos, intMyPos, arlMySource, intParPos, arlParSource, ref intParSkip, ref intMySkip, ref intVariablePop);
            break;
          //----------------------------------------------------------------
          case "end":
            BufferCheck(ref intMyBufferPos, intParBufferPos, intMyPos, arlMySource, intParPos, arlParSource, ref intParSkip, ref intMySkip, ref intVariablePop);
          ...
          /*case "desc":
            {
              ...
              if (objVar != null && IsString(objVar))
              {
                strNextDesc = ((string)objVar).Substring(1, ((string)objVar).Length - 2);
                intMySkip = 1;
              }
            }
            break;*/
          ...
          case "unset":
            {
              ...
              if (objVar != null)
              {
                ...
                if (intVarIndex != -1)
                {
                  ...
                  //lstVarDesc.RemoveAt(intVarIndex);
                  intMySkip = 1;
                }
              }
            }
          ...
          case "local":
            {
              object objVar = GetNextSymbol(1, intMyPos, arlMySource);
              if (objVar != null && objVar.GetType() == typeof(string))
              {
                lstVariables.Insert(0, (string)objVar);
                arlVariableValues.Insert(0, null);
                //lstVarDesc.Insert(0, strNextDesc);
                //strNextDesc = null;
          ...
          case "=l":
            {
              ...
              {
                lstVariables.Insert(0, (string)objVar);
                arlVariableValues.Insert(0, objValue);
                //lstVarDesc.Insert(0, strNextDesc);
                //strNextDesc = null;
          ...
          case "if":
            {
              ...
              if (arlBuffer.Count - intMyBufferPos == 0)
              {
                LetterEval(GetNextSymbol(1, intMyPos, arlMySource), ref intMyBufferPos, intParBufferPos, intMyPos + 1, arlMySource, intParPos, arlParSource, ref intMySkip, ref intParSkip, ref intVariablePop);
                intShift = 1;
              }
              ...
              {
                LetterEval(GetNextSymbol(1 + intShift, intMyPos, arlMySource), ref intMyBufferPos, intParBufferPos, intMyPos + 1 + intShift, arlMySource, intParPos, arlParSource, ref intMySkip, ref intParSkip, ref intVariablePop);
              ...
              else
              {
                ...
                {
                  LetterEval(GetNextSymbol(3 + intShift, intMyPos, arlMySource), ref intMyBufferPos, intParBufferPos, intMyPos + 3 + intShift, arlMySource, intParPos, arlParSource, ref intMySkip, ref intParSkip, ref intVariablePop);
                  intShift += 2;
                }
              }
          ...
          case "while":
            {
              ...
              {
                LetterEval(objCond, ref intMyBufferPos, intParBufferPos, intMyPos + 1, arlMySource, intParPos, arlParSource, ref intMySkip, ref intParSkip, ref intVariablePop);
                if (arlBuffer.Count - intMyBufferPos > 0)
                {
                  objTest = arlBuffer[arlBuffer.Count - 1];
                  arlBuffer.RemoveAt(arlBuffer.Count - 1);
                ...
                {
                  LetterEval(objDo, ref intMyBufferPos, intParBufferPos, intMyPos + 2, arlMySource, intParPos, arlParSource, ref intMySkip, ref intParSkip, ref intVariablePop);
          ...
          case "!":
            if (arlBuffer.Count - intMyBufferPos > 0)
            {
              ArrayList lstTmp = TakeAny(-1, 1, intMyBufferPos, arlBuffer.Count);
          ...
          case "next":
            if (arlBuffer.Count - intMyBufferPos > 0)
            {
              ...
              if (lstDblTmp.Count > 0)
              {
                ...
                if (objTmp != null)
                {
                  LetterEval(objTmp, ref intMyBufferPos, intParBufferPos, intMyPos, arlMySource, intParPos, arlParSource, ref intMySkip, ref intParSkip, ref intVariablePop);
                  /*if (objTmp.GetType() == typeof(ArrayList))
                    MittoEval((ArrayList)objTmp, arlBuffer, intParPos, arlParentBuffer == null ? arlParSource : arlBuffer, ref intParSkip);
          ...
          case "take":
            if (arlBuffer.Count - intMyBufferPos > 0)
            {
              ...
              if (lstDblTmp.Count > 0)
              {
                /*ArrayList arlTmp = TakeAny((int)lstDblTmp[0], 0, intParBufferPos, intMyBufferPos);
                arlBuffer.AddRange(arlTmp);*/
                intMyBufferPos -= (int)lstDblTmp[0];
              }
              else
                arlBuffer.Add(strEval);
            }
    ...
    //--------------------------------------------------------------------------------------------------------------------------------
    public void MittoEval(ArrayList arlEval, int intParBufferPos, int intParPos, ArrayList arlParSource, ref int intParSkip)
    {
      ...
      for (i = 0; i < arlEval.Count; i++)
      {
        ...
        if (arlEval[i].GetType() == typeof(ArrayList)) {
          MittoEval((ArrayList)arlEval[i], intMyBufferPos, i, arlEval, ref intMySkip);
        }
        ...
        {
          SymbolEval((string)arlEval[i], ref intMyBufferPos, intParBufferPos, i, arlEval, intParPos, arlParSource, ref intMySkip, ref intParSkip, ref intVariablePop);
        }
      ...
      if (arlBuffer.Count - intMyBufferPos > 0)
      {
        BufferCheck(ref intMyBufferPos, intParBufferPos, i, arlEval, intParPos, arlParSource, ref intParSkip, ref intMySkip, ref intParSkip);
      }

      if (intVariablePop > 0)
      {
        for (i = 0; i < intVariablePop; i++)
        {
          lstVariables.RemoveAt(0);
          arlVariableValues.RemoveAt(0);
          //lstVarDesc.RemoveAt(0);
        }
      }
    }
